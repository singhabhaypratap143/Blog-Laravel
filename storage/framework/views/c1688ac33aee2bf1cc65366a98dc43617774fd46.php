    ...
    <main class="container">
      <section class="single-blog-post">
        ...
        <div class="single-blog-post-ContentImage" data-aos="fade-left">
          <img src="<?php echo e(asset('images/photography.jpg')); ?>" alt="" />
        </div>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Abhay pratap singh\Desktop\xamp\htdocs\blognew\resources\views/about.blade.php ENDPATH**/ ?>